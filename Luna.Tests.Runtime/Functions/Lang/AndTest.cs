...
internal class AndTest : BaseFunctionTest<And>
{
    ...
    {
        var result = GetValue<BooleanRuntimeValue>(new BooleanRuntimeValue(true), new BooleanRuntimeValue(true));
    ...
    {
        var result = GetValue<BooleanRuntimeValue>(new BooleanRuntimeValue(false), new ErrorBooleanRuntimeValue());
    ...
    {
        var result = GetValue<BooleanRuntimeValue>(new BooleanRuntimeValue(true), new BooleanRuntimeValue(false));
        Assert.False(result.Value);
    }
}
