...
internal class OrTest : BaseFunctionTest<Or>
{
    ...
    {
        var result = GetValue<BooleanRuntimeValue>(new BooleanRuntimeValue(true), new ErrorBooleanRuntimeValue());
    ...
    {
        var result = GetValue<BooleanRuntimeValue>(new BooleanRuntimeValue(false), new BooleanRuntimeValue(false));
    ...
    {
        var result = GetValue<BooleanRuntimeValue>(new BooleanRuntimeValue(false), new BooleanRuntimeValue(true));
        Assert.True(result.Value);
    }
}
