...
internal class MulTest : BaseFunctionTest<Mul>
{
    ...
    {
        var result = GetValue<IntegerRuntimeValue>(new IRuntimeValue[] { new IntegerRuntimeValue(2), new IntegerRuntimeValue(8) });
    ...
    {
        var result = GetValue<FloatRuntimeValue>(new IRuntimeValue[] { new FloatRuntimeValue(2.0), new IntegerRuntimeValue(8) });
    ...
    {
        var result = GetValue<FloatRuntimeValue>(new IRuntimeValue[] { new FloatRuntimeValue(2.0), new FloatRuntimeValue(8.0) });
        Assert.AreEqual(16.0, result.FloatValue);
    }
}
