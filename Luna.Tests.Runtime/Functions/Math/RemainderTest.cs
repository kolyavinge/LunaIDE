...
internal class RemainderTest : BaseFunctionTest<Remainder>
{
    ...
    {
        var result = GetValue<IntegerRuntimeValue>(new IntegerRuntimeValue(8), new IntegerRuntimeValue(3));
    ...
    {
        var result = GetValue<FloatRuntimeValue>(new FloatRuntimeValue(8.0), new IntegerRuntimeValue(3));
    ...
    {
        var result = GetValue<FloatRuntimeValue>(new IntegerRuntimeValue(8), new FloatRuntimeValue(3.0));
        Assert.AreEqual(2.0, result.FloatValue);
    }
    ...
    {
        var result = GetValue<FloatRuntimeValue>(new FloatRuntimeValue(8.0), new FloatRuntimeValue(3.0));
        Assert.AreEqual(2.0, result.FloatValue);
    }
}