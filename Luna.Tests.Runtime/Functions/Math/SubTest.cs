...
internal class Subest : BaseFunctionTest<Sub>
{
    ...
    {
        var result = (IntegerRuntimeValue)GetValue(new IRuntimeValue[] { new IntegerRuntimeValue(8), new IntegerRuntimeValue(2) });
    ...
    {
        var result = (FloatRuntimeValue)GetValue(new IRuntimeValue[] { new FloatRuntimeValue(8.0), new IntegerRuntimeValue(2) });
    ...
    {
        var result = (FloatRuntimeValue)GetValue(new IRuntimeValue[] { new FloatRuntimeValue(8.0), new FloatRuntimeValue(2.0) });
        Assert.AreEqual(6.0, result.FloatValue);
    }
}
