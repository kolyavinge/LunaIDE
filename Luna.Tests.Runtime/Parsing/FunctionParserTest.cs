...
internal class FunctionParserTest
{
    ...
    public void ConstDeclaration_Correct_Integer()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("// comment", 0, 16, TokenKind.Comment)
        });
    ...
    public void ConstDeclaration_IntegerValueOverflow()
    {
        Parse(new Token[]
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("WIDTH", 0, 6, TokenKind.Identificator),
            new("11111111111111111111111111111111111111111111111111", 0, 12, TokenKind.IntegerNumber)
        });
        Assert.AreEqual(1, _codeModel.Constants.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IntegerValueOverflow, _result.Errors.First().Type);
        Assert.AreEqual(new Token("11111111111111111111111111111111111111111111111111", 0, 12, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_Correct_Float()
    {
        ...
        Parse(new Token[]
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("WIDTH", 0, 6, TokenKind.Identificator),
            new("1.23", 0, 12, TokenKind.FloatNumber),
            new("// comment", 0, 17, TokenKind.Comment)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Constants.Count);
    ...
    public void ConstDeclaration_Correct_BooleanTrue()
    {
        ...
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("TRUE", 0, 6, TokenKind.Identificator),
            new("true", 0, 11, TokenKind.BooleanTrue),
            new("// comment", 0, 15, TokenKind.Comment)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Constants.Count);
    ...
    public void ConstDeclaration_Correct_BooleanFalse()
    {
        ...
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("FALSE", 0, 6, TokenKind.Identificator),
            new("false", 0, 12, TokenKind.BooleanFalse),
            new("// comment", 0, 17, TokenKind.Comment)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void ConstDeclaration_Correct_String()
    {
        ...
        Parse(new Token[]
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("WIDTH", 0, 6, TokenKind.Identificator),
            new("'123'", 0, 12, TokenKind.String),
            new("// comment", 0, 18, TokenKind.Comment)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Constants.Count);
    ...
    public void ConstDeclaration_Correct_2()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("VALUE", 1, 6, TokenKind.Identificator),
            new("456", 1, 12, TokenKind.IntegerNumber)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void ConstDeclaration_ConstNameExist()
    {
        ...
        Assert.AreEqual(new Token("WIDTH", 0, 6, TokenKind.Identificator), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_EmptyDeclaration()
    {
        ...
        Assert.AreEqual(new Token("const", 0, 0, TokenKind.ConstDeclaration), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_IncorrectName_String()
    {
        ...
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("'123'", 0, 6, TokenKind.String)
        });
        Assert.AreEqual(0, _codeModel.Constants.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectConstName, _result.Errors.First().Type);
        Assert.AreEqual(new Token("'123'", 0, 6, TokenKind.String), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_IncorrectName_Integer()
    {
        ...
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("123", 0, 6, TokenKind.IntegerNumber)
        });
        Assert.AreEqual(0, _codeModel.Constants.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectConstName, _result.Errors.First().Type);
        Assert.AreEqual(new Token("123", 0, 6, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_IncorrectName_Float()
    {
        ...
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("1.23", 0, 6, TokenKind.FloatNumber)
        });
        Assert.AreEqual(0, _codeModel.Constants.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectConstName, _result.Errors.First().Type);
        Assert.AreEqual(new Token("1.23", 0, 6, TokenKind.FloatNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_IncorrectValue()
    {
        ...
        Parse(new Token[]
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("WIDTH", 0, 6, TokenKind.Identificator),
            new("VALUE", 0, 12, TokenKind.Identificator)
        });
        Assert.AreEqual(1, _codeModel.Constants.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.ConstIncorrectValue, _result.Errors.First().Type);
        Assert.AreEqual(new Token("VALUE", 0, 12, TokenKind.Identificator), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_UnexpectedTokens()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("WIDTH", 0, 6, TokenKind.Identificator),
            new("123", 0, 12, TokenKind.IntegerNumber),
            new("const", 0, 16, TokenKind.ConstDeclaration),
            new("VALUE", 0, 22, TokenKind.Identificator),
            new("456", 0, 28, TokenKind.IntegerNumber)
        });
        Assert.AreEqual(0, _codeModel.Constants.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.UnexpectedToken, _result.Errors.First().Type);
        Assert.AreEqual(new Token("const", 0, 16, TokenKind.ConstDeclaration), _result.Errors.First().Tokens[0]);
        Assert.AreEqual(new Token("VALUE", 0, 22, TokenKind.Identificator), _result.Errors.First().Tokens[1]);
        Assert.AreEqual(new Token("456", 0, 28, TokenKind.IntegerNumber), _result.Errors.First().Tokens[2]);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_UnexpectedImportDirective()
    {
        ...
        Assert.AreEqual(new Token("import", 1, 0, TokenKind.ImportDirective), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_FirstConstIncorrect()
    {
        ...
        Parse(new Token[]
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("WIDTH", 0, 6, TokenKind.Identificator),
            new("1x", 0, 12, TokenKind.Unknown),
            new("const", 1, 0, TokenKind.ConstDeclaration),
            new("HEIGHT", 1, 6, TokenKind.Identificator),
            new("2", 1, 13, TokenKind.IntegerNumber)
        });
        Assert.AreEqual(0, _codeModel.Imports.Count);
        Assert.AreEqual(2, _codeModel.Constants.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.ConstIncorrectValue, _result.Errors.First().Type);
        Assert.AreEqual(new Token("1x", 0, 12, TokenKind.Unknown), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void ConstDeclaration_FirstConstNoValue()
    {
        ...
        Parse(new Token[]
        {
            new("const", 0, 0, TokenKind.ConstDeclaration),
            new("WIDTH", 0, 6, TokenKind.Identificator),
            new("// comment", 0, 13, TokenKind.Comment),
            new("const", 1, 0, TokenKind.ConstDeclaration),
            new("HEIGHT", 1, 6, TokenKind.Identificator),
            new("2", 1, 13, TokenKind.IntegerNumber)
        });
    ...
    public void ConstDeclaration_UnexpectedFirstConst()
    {
        ...
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.UnexpectedToken, _result.Errors.First().Type);
        Assert.AreEqual(new Token("123", 0, 0, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_LineAndColumn()
    {
        ...
        Parse(new Token[]
        {
            new("(", 1, 2, TokenKind.OpenBracket),
            new("func", 1, 3, TokenKind.Identificator),
            new("(", 1, 8, TokenKind.OpenBracket),
            new(")", 1, 8, TokenKind.CloseBracket),
            new("1", 1, 11, TokenKind.IntegerNumber),
            new(")", 1, 12, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void FunctionDeclaration_IncorrectFunctionName()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("'func'", 0, 1, TokenKind.String),
            new("(", 0, 8, TokenKind.OpenBracket),
            new(")", 0, 9, TokenKind.CloseBracket),
            new("1", 0, 11, TokenKind.IntegerNumber),
            new(")", 0, 12, TokenKind.CloseBracket)
        });
        ...
        Assert.AreEqual(new Token("'func'", 0, 1, TokenKind.String), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_IncorrectAgrumentsDeclaration()
    {
        ...
        {
            new("(", 0, 0, TokenKind.OpenBracket),
            new("func", 0, 1, TokenKind.Identificator),
            new("1", 0, 6, TokenKind.IntegerNumber),
            new("1", 0, 8, TokenKind.IntegerNumber),
            new(")", 0, 9, TokenKind.CloseBracket)
        });
        Assert.AreEqual(0, _codeModel.Functions.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectFunctionAgrumentsDeclaration, _result.Errors.First().Type);
        Assert.AreEqual(new Token("1", 0, 6, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_IncorrectAgrument()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 1, 9, TokenKind.CloseBracket),
            new("1", 1, 12, TokenKind.IntegerNumber),
            new(")", 1, 13, TokenKind.CloseBracket)
        });
        Assert.AreEqual(0, _codeModel.Functions.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectFunctionAgrument, _result.Errors.First().Type);
        Assert.AreEqual(new Token("1", 1, 9, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_UnexpectedEnd()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 0, 7, TokenKind.CloseBracket),
            new("1", 0, 9, TokenKind.IntegerNumber)
        });
        Assert.AreEqual(1, _codeModel.Functions.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.UnexpectedFunctionEnd, _result.Errors.First().Type);
        Assert.AreEqual(new Token("1", 0, 9, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_Arguments_Correct()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("func", 0, 1, TokenKind.Identificator),
            new("(", 0, 6, TokenKind.OpenBracket),
            new("xxx", 0, 7, TokenKind.Identificator),
            new("yyy", 0, 11, TokenKind.Identificator),
            new("zzz", 0, 15, TokenKind.Identificator),
            new(")", 0, 18, TokenKind.CloseBracket),
            new("1", 0, 20, TokenKind.IntegerNumber),
            new(")", 0, 21, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_Body_IncorrectToken()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 6, TokenKind.OpenBracket),
            new(")", 0, 7, TokenKind.CloseBracket),
            new("^", 0, 9, TokenKind.Unknown)
        });
        Assert.AreEqual(1, _codeModel.Functions.Count);
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectToken, _result.Errors.First().Type);
        Assert.AreEqual(new Token("^", 0, 9, TokenKind.Unknown), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_Arguments_LastIncorrect()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("xxx", 0, 7, TokenKind.Identificator),
            new("yyy", 0, 11, TokenKind.Identificator),
            new("111", 0, 15, TokenKind.IntegerNumber),
            new(")", 0, 18, TokenKind.CloseBracket),
            new("1", 0, 20, TokenKind.IntegerNumber),
            new(")", 0, 21, TokenKind.CloseBracket)
        });
        ...
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectFunctionAgrument, _result.Errors.First().Type);
        Assert.AreEqual(new Token("111", 0, 15, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_Arguments_NoCloseBracket()
    {
        ...
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectFunctionAgrumentsDeclaration, _result.Errors.First().Type);
        Assert.AreEqual(new Token("", 0, 0, TokenKind.Unknown), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
    }
    ...
    public void FunctionDeclaration_OneIntegerConstant()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 0, 7, TokenKind.CloseBracket),
            new("1", 0, 9, TokenKind.IntegerNumber),
            new(")", 0, 10, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_IntegerValueOverflow()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 6, TokenKind.OpenBracket),
            new(")", 0, 7, TokenKind.CloseBracket),
            new("11111111111111111111111111111111111111111111111111", 0, 9, TokenKind.IntegerNumber),
            new(")", 0, 51, TokenKind.CloseBracket)
        });
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IntegerValueOverflow, _result.Errors.First().Type);
        Assert.AreEqual(new Token("11111111111111111111111111111111111111111111111111", 0, 9, TokenKind.IntegerNumber), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    }
    ...
    public void FunctionDeclaration_OneFloatConstant()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 6, TokenKind.OpenBracket),
            new(")", 0, 7, TokenKind.CloseBracket),
            new("1.2", 0, 9, TokenKind.FloatNumber),
            new(")", 0, 12, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void FunctionDeclaration_OneStringConstant()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 6, TokenKind.OpenBracket),
            new(")", 0, 7, TokenKind.CloseBracket),
            new("'str'", 0, 9, TokenKind.String),
            new(")", 0, 14, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_BooleanList()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 6, TokenKind.OpenBracket),
            new(")", 0, 7, TokenKind.CloseBracket),
            new("(", 0, 9, TokenKind.OpenBracket),
            new("true", 0, 10, TokenKind.BooleanTrue),
            new("false", 0, 15, TokenKind.BooleanFalse),
            new(")", 0, 20, TokenKind.CloseBracket),
            new(")", 0, 21, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void FunctionDeclaration_OneList()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 0, 7, TokenKind.CloseBracket),
            new("(", 0, 9, TokenKind.OpenBracket),
            new("1", 0, 10, TokenKind.IntegerNumber),
            new("1.2", 0, 12, TokenKind.FloatNumber),
            new("'str'", 0, 16, TokenKind.String),
            new(")", 0, 21, TokenKind.CloseBracket),
            new(")", 0, 22, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_OneNamedConstant()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 6, TokenKind.OpenBracket),
            new(")", 0, 7, TokenKind.CloseBracket),
            new("WIDTH", 0, 9, TokenKind.Identificator),
            new(")", 0, 14, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void FunctionDeclaration_OneNamedConstantInList()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 0, 15, TokenKind.CloseBracket),
            new(")", 0, 16, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_Function()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 6, TokenKind.OpenBracket),
            new(")", 0, 7, TokenKind.CloseBracket),
            new("print", 0, 9, TokenKind.Identificator),
            new(")", 0, 14, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void FunctionDeclaration_FunctionAlreadyExist()
    {
        ...
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.FunctionNameExist, _result.Errors.First().Type);
        Assert.AreEqual(new Token("func", 0, 1, TokenKind.Identificator), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(0, _codeModel.Functions.Count);
    }
    ...
    public void FunctionDeclaration_Variable()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("func", 0, 1, TokenKind.Identificator),
            new("(", 0, 6, TokenKind.OpenBracket),
            new("x", 0, 7, TokenKind.Identificator),
            new(")", 0, 8, TokenKind.CloseBracket),
            new("x", 0, 10, TokenKind.Identificator),
            new(")", 0, 11, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_OneFunctionCall()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("1", 0, 9, TokenKind.IntegerNumber),
            new("1.2", 0, 11, TokenKind.FloatNumber),
            new("'str'", 0, 15, TokenKind.String),
            new(")", 0, 20, TokenKind.CloseBracket),
            new(")", 0, 21, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
    ...
    public void FunctionDeclaration_InnerFunctionCall()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("g", 0, 7, TokenKind.Identificator),
            new("1", 0, 9, TokenKind.IntegerNumber),
            new("(", 0, 11, TokenKind.OpenBracket),
            new("k", 0, 12, TokenKind.Identificator),
            new("1", 0, 14, TokenKind.IntegerNumber),
            new("2", 0, 16, TokenKind.IntegerNumber),
            new(")", 0, 17, TokenKind.CloseBracket),
            new("'str'", 0, 19, TokenKind.String),
            new(")", 0, 24, TokenKind.CloseBracket),
            new(")", 0, 25, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_Lambda()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 0, 4, TokenKind.CloseBracket),
            new("(", 0, 6, TokenKind.OpenBracket),
            new("lambda", 0, 7, TokenKind.Lambda),
            new("(", 0, 14, TokenKind.OpenBracket),
            new("x", 0, 15, TokenKind.Identificator),
            new(")", 0, 16, TokenKind.CloseBracket),
            new("(", 0, 18, TokenKind.OpenBracket),
            new("g", 0, 19, TokenKind.Identificator),
            new("x", 0, 21, TokenKind.Identificator),
            new(")", 0, 22, TokenKind.CloseBracket),
            new(")", 0, 23, TokenKind.CloseBracket),
            new(")", 0, 24, TokenKind.CloseBracket)
        });
    ...
    public void FunctionDeclaration_Lambda_TwoItemsBody()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("x", 0, 21, TokenKind.Identificator),
            new(")", 0, 22, TokenKind.CloseBracket),
            new("(", 0, 24, TokenKind.OpenBracket),
            new("h", 0, 25, TokenKind.Identificator),
            new("x", 0, 27, TokenKind.Identificator),
            new(")", 0, 28, TokenKind.CloseBracket),
            new(")", 0, 29, TokenKind.CloseBracket),
            new(")", 0, 30, TokenKind.CloseBracket)
        });
    ...
    public void FunctionDeclaration_Lambda_IncorrectArguments()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("lambda", 0, 7, TokenKind.Lambda),
            new("(", 0, 14, TokenKind.OpenBracket),
            new("^", 0, 15, TokenKind.Unknown)
        });
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectFunctionAgrument, _result.Errors.First().Type);
        Assert.AreEqual(new Token("^", 0, 15, TokenKind.Unknown), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    }
    ...
    public void FunctionDeclaration_Lambda_IncorrectBody()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 0, 16, TokenKind.CloseBracket),
            new("(", 0, 18, TokenKind.OpenBracket),
            new("^", 0, 19, TokenKind.Unknown)
        });
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.IncorrectToken, _result.Errors.First().Type);
        Assert.AreEqual(new Token("^", 0, 19, TokenKind.Unknown), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    }
    ...
    public void FunctionDeclaration_TwoFunctionsInBody()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 7, TokenKind.OpenBracket),
            new("g", 0, 8, TokenKind.Identificator),
            new("1", 0, 10, TokenKind.IntegerNumber),
            new(")", 0, 11, TokenKind.CloseBracket),
            new("(", 0, 13, TokenKind.OpenBracket),
            new("h", 0, 14, TokenKind.Identificator),
            new("2", 0, 16, TokenKind.IntegerNumber),
            new(")", 0, 17, TokenKind.CloseBracket),
            new(")", 0, 19, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_MathOperators()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 7, TokenKind.OpenBracket),
            new("+", 0, 8, TokenKind.Plus),
            new("1", 0, 10, TokenKind.IntegerNumber),
            new("2", 0, 12, TokenKind.IntegerNumber),
            new(")", 0, 13, TokenKind.CloseBracket),

            new("(", 0, 15, TokenKind.OpenBracket),
            new("-", 0, 16, TokenKind.Minus),
            new("1", 0, 18, TokenKind.IntegerNumber),
            new("2", 0, 20, TokenKind.IntegerNumber),
            new(")", 0, 21, TokenKind.CloseBracket),

            new("(", 0, 23, TokenKind.OpenBracket),
            new("*", 0, 24, TokenKind.Asterisk),
            new("1", 0, 26, TokenKind.IntegerNumber),
            new("2", 0, 28, TokenKind.IntegerNumber),
            new(")", 0, 29, TokenKind.CloseBracket),

            new("(", 0, 31, TokenKind.OpenBracket),
            new("/", 0, 32, TokenKind.Slash),
            new("1", 0, 34, TokenKind.IntegerNumber),
            new("2", 0, 36, TokenKind.IntegerNumber),
            new(")", 0, 37, TokenKind.CloseBracket),

            new("(", 0, 39, TokenKind.OpenBracket),
            new("%", 0, 40, TokenKind.Percent),
            new("1", 0, 42, TokenKind.IntegerNumber),
            new("2", 0, 44, TokenKind.IntegerNumber),
            new(")", 0, 45, TokenKind.CloseBracket),

            new(")", 0, 39, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.AreEqual(1, _codeModel.Functions.Count);
    ...
    public void FunctionDeclaration_MathOperatorsAsArgumentValues()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 7, TokenKind.OpenBracket),
            new("g", 0, 8, TokenKind.Identificator),
            new("+", 0, 10, TokenKind.Plus),
            new("-", 0, 12, TokenKind.Minus),
            new("*", 0, 14, TokenKind.Asterisk),
            new("/", 0, 16, TokenKind.Slash),
            new("%", 0, 18, TokenKind.Percent),
            new(")", 0, 19, TokenKind.CloseBracket),
    ...
    public void FunctionDeclaration_GetVariable()
    {
        ...
        Parse(new Token[]
        {
            ...
            new("(", 0, 3, TokenKind.OpenBracket),
            new(")", 0, 4, TokenKind.CloseBracket),
            new("@var", 0, 6, TokenKind.Variable),
            new(")", 0, 11, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
        Assert.AreEqual(0, _result.Warnings.Count);
    ...
    public void FunctionDeclaration_SetVariable()
    {
        ...
        Parse(new Token[]
        {
            ...
            new(")", 0, 4, TokenKind.CloseBracket),
            new("(", 0, 6, TokenKind.OpenBracket),
            new("set", 0, 7, TokenKind.Identificator),
            new("@var", 0, 11, TokenKind.Variable),
            new("1", 0, 16, TokenKind.IntegerNumber),
            new(")", 0, 17, TokenKind.CloseBracket),
            new(")", 0, 18, TokenKind.CloseBracket)
        });
        Assert.False(_result.Errors.Any());
    ...
    public void FunctionDeclaration_UnexpectedFirstConst()
    {
        ...
        {
            new("123", 0, 0, TokenKind.IntegerNumber),
            new("(", 1, 0, TokenKind.OpenBracket),
            new("func", 1, 1, TokenKind.Identificator),
            new("(", 1, 6, TokenKind.OpenBracket),
            new("x", 1, 7, TokenKind.Identificator),
            new(")", 1, 8, TokenKind.CloseBracket),
            new("x", 1, 10, TokenKind.Identificator),
            new(")", 1, 11, TokenKind.CloseBracket)
        });
        Assert.AreEqual(1, _result.Errors.Count);
        Assert.AreEqual(ParserMessageType.UnexpectedToken, _result.Errors.First().Type);
    ...
    public void RunFunctionCall()
    {
        ...
        {
            new("(", 0, 0, TokenKind.OpenBracket),
            new("run", 0, 1, TokenKind.RunFunction),
            new("(", 0, 5, TokenKind.OpenBracket),
            new("f", 0, 6, TokenKind.Identificator),
            new("1", 0, 8, TokenKind.IntegerNumber),
            new(")", 0, 9, TokenKind.CloseBracket),
            new(")", 0, 10, TokenKind.CloseBracket)
        });
    ...
    public void RunFunctionExist()
    {
        ...
        Assert.AreEqual(new Token("run", 0, 1, TokenKind.RunFunction), _result.Errors.First().Token);
        Assert.AreEqual(0, _result.Warnings.Count);
        Assert.IsNull(_codeModel.RunFunction);
    }
